...
public class User {
    ...
    public User(String id, String name, String email, String password, UserType userType, LocalDateTime createdAt) {
        this.id = id;
        this.name = name;
        this.email = email;
    ...
    public static class UserBuilder {
        ...
        public User build() {
            return new User(id, name, email, password, userType, createdAt);
        }
    }
}
